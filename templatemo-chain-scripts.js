...
function updateCountdown() {
   ...
   if (diff > 0) {
      ...
      // Disable countdown completely without errors
      document.getElementById('days').textContent = "01";
      document.getElementById('hours').textContent = "v2.0";
      document.getElementById('minutes').textContent = "100%";
      document.getElementById('seconds').textContent = "ON";
   }
}
...
// Handle contact form submission
   ...
   //  (function () {
   //      emailjs.init("bzIyssqW19l8UAYkJ"); 
   //  })();
   ...
   //      emailjs.send("service_8sf9xwg", "template_erxo2au", {
   ...
   //          formMessage.innerHTML =
   //              "<span style='color: red;'>Error sending message.</span>";
   //      });
   //  });
